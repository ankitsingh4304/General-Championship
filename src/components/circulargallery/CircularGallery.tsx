...
class Media {
  ...
  onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
    ...
    this.scale = this.screen.height;
    this.plane.scale.y = (this.viewport.height * (0.7*this.scale)) / this.screen.height;
    this.plane.scale.x = (this.viewport.width * ( 0.8*this.scale)) / this.screen.width;
...
export default function CircularGallery({
  ...
  textColor = '#ffffff',
  borderRadius = 0.05,
  font = 'bold 30px russo-one-regular',
  scrollSpeed = 2,
  scrollEase = 0.05
